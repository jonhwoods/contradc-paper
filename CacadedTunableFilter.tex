...
\begin{abstract}
	...
	This result was achieved using cascaded Bragg-grating-assisted contra-directional couplers and micro-heaters on the 220-nm silicon-on-insulator platform with a footprint of less than 7,000~\textmu m$^2$. Another design with the bandwidth continuously tunable from 50 GHz to 1 THz is also presented. 
\end{abstract}
